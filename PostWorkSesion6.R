...
ventas sobre la base de los tres presupuestos de medios de comunicación. Ajuste modelos de regresión lineal múltiple a los datos advertisement.csv y elija el modelo más adecuado siguiendo los procedimientos vistos
Considera:
...
# la diferencia es mínima entre ambos modelos (modelo1=0.9011 y modelo2=0.9016)

#Cómo no hay variables dicotómicas no se pueden establecer términos de iteración

"conclusión: Si se invierte en Radio se tiene un aumento en las ventas de 0.10 unidades"
